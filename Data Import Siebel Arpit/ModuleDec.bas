...
Public Const pubWrkDesigStr As String = "'WASHER','SUPERVISOR','MECHANIC','HELPER','ELECTRICIAN','DENTER'"
Public mPrinterName$
'21-04-2003
...
Public ForSiteCode As String * 1
...
Public GCn As adodb.Connection       'Connection To Central Database
Public GCnFaV As adodb.Connection   'Connection To FaData Vehicle
Public GCnFaS As adodb.Connection   'Connection To FaData Spares
Public GCnFaW As adodb.Connection   'Connection To FaData WorkShop
Public GCnFa As adodb.Connection     'Connection To FaData
Public GCnComp As adodb.Connection   'Connection To Company DataBase
Public GCnTemp As adodb.Connection   'Connection Temporary
Public GRs As adodb.Recordset        'Global Recordset
...
'mChr14 = Chr(14)  'enlarged characters 5 characters per inch
'Public Const mChr10 As String = Chr(10) '10 charactergs per inch Normal Size
'Public Const mChr15 As String = Chr(15) '15 characters per inc
'Public Const mChr18 As String = Chr(18) '18 charactergs per inch
'Public Const mChr20 As String = Chr(27) + Chr(77) + Chr(15) '20 characters per inch
'Public Const mChr201 As String = Chr(27) + Chr(80) + Chr(18) 'Off 20 character pitch
'Public Const mEmph As String = Chr(27) + Chr(69) 'Emphasis current pitch
'Public Const mEmph1 As String = Chr(27) + Chr(70) 'Off Emphasis
'Public Const mDoub As String = Chr(27) + Chr(71)  'Double Strike
'Public Const mDoub1 As String = Chr(27) + Chr(72) 'Off Double Strike
'Public Const mUnd As String = Chr(27) + Chr(45) + Chr(1) 'UnderLine
'Public Const mUnd1 As String = Chr(27) + Chr(45) + Chr(0) 'Off Underline
'Public Const mChrHt As String = Chr(27) + "w1" + Chr(27) + "W1" + Chr(27) + "E" + Chr(27) + "G" 'increase height
'Public Const mChrHt1 As String = Chr(27) + "H" + Chr(27) + "F" + Chr(27) + "w0" + Chr(27) + "W0" 'Off height
'Public Const mEject As String = Chr(12)        '// PAGE EJECT

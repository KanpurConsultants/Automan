...
Private Const MC_ProduceMaster As Byte = 23
...
FrmMdiBack.Move Me.left + 80, Me.top + 100
FrmMdiBack.Show
...
Select Case Index
    ...
    Case MC_ProduceMaster
        If FrmProduceMaster.Visible = False Then FrmProduceMaster.Show: Set FrmProduceMaster = Nothing
End Select
End Sub
...
ElseIf PubBackEnd = "S" Then
    ...
    GCn.Execute "Alter Table  Part_Grade Add TaxFormPurchase nVarChar(4)   Default ''"
    GCn.Execute "Alter Table  Part_Grade Add TaxFormSales    nVarChar(4)   Default ''"
        
    GCn.Execute "Alter Table Sp_Stock Add TaxForm nVarchar(4)"
    ...
    GCn.Execute "Alter Table Model_Cat Add Produce_Code Varchar(3)"
...
On Error Resume Next
    ...
    GCn.Execute "CREATE TABLE dbo.Produce " & _
            "( " & _
            "Produce_Code NVARCHAR (3) CONSTRAINT DF_Produce_Produce_Code DEFAULT ('') NOT NULL, " & _
            "Site_Code     NVARCHAR (1) CONSTRAINT DF_Produce_Site_Code DEFAULT ('') NOT NULL, " & _
            "Produce_Name NVARCHAR (20) CONSTRAINT DF_Produce_Produce_Name DEFAULT ('') NOT NULL, " & _
            "U_Name        NVARCHAR (10) CONSTRAINT DF_Produce_U_Name DEFAULT ('') NOT NULL, " & _
            "U_EntDt       SMALLDATETIME NOT NULL, " & _
            "U_AE          NVARCHAR (1) CONSTRAINT DF_Produce_U_AE DEFAULT ('') NOT NULL, " & _
            "Trf_Date      SMALLDATETIME NULL, " & _
            "OldCode       NVARCHAR (3) CONSTRAINT DF_Produce_OldCode DEFAULT ('') NULL, " & _
            "DmsCode       NVARCHAR (50) DEFAULT ('') NULL, " & _
            "CONSTRAINT PK_Produce PRIMARY KEY (Produce_Code) " & _
            ")"

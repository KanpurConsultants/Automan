...
Begin VB.Form RP_WarClmSumm 
   ...
   End
End
Attribute VB_Name = "RP_WarClmSumm"
...
'Report Index
Private Const V_ClaimSummary As Byte = 1          'Claims Summary
...
Private Const OptSpare  As Byte = 1
Private Const OptLabour As Byte = 2
...
StartReport:
    SqlQry = "select jw3.div_code,jw3.site_code,Jw3.Year_Prefix,JW3.Claim_Type,JW3.Claim_No,Jw3.Year_Prefix+JW3.Claim_Type+JW3.Claim_No as Prowac,JW3.Claim_Date, " & _
             "JW3.LABOUR_AMT+JW3.SPL_CHRG as LabourClaim,(JW3.NDP*JW3.CLAIM_QTY)+JW3.MISC_CHRG as SpareClaim," & _
             "" & cIIF("Jw3.crnoteno<>''", "JW3.LABOUR_PASS+JW3.SPL_PASS", "0") & " as LabourPass, " & cIIF("Jw3.crnoteno<>''", "JW3.SPR_PASS+JW3.MISC_PASS", "0") & " as SparePass," & _
             "" & cIIF("Jw3.Claim_Rejected=1", "JW3.LABOUR_AMT+JW3.SPL_CHRG", "0") & " as LabourReject, " & cIIF("Jw3.Claim_Rejected=1", "(JW3.NDP*JW3.CLAIM_QTY)+JW3.MISC_CHRG", "0") & " as SpareReject," & _
             "" & cIIF("Jw3.crnoteno='' or jw3.crnoteno Is Null", "JW3.LABOUR_AMT+JW3.SPL_CHRG", "0") & " as LabourOutstand, " & cIIF("Jw3.crnoteno='' or jw3.crnoteno Is Null", "(JW3.NDP*JW3.CLAIM_QTY)+JW3.MISC_CHRG", "0") & " as SpareOutstand " & _
             "FROM JOB_WARR3 AS JW3 Left JOIN JOB_WARR1 AS JW1 ON JW3.DIV_CODE=JW1.DIV_CODE and " & _
             "JW3.SITE_CODE=JW1.SITE_CODE and JW3.YEAR_PREFIX=JW1.YEAR_PREFIX and  JW3.CLAIM_TYPE=JW1.CLAIM_TYPE and  JW3.CLAIM_NO=JW1.CLAIM_NO "

...
Dim op1 As String
    ...
    If I = 135 And Not IsDate(Text1) Then MsgBox "Invalid Date", vbInformation, "Information": Exit Sub
    op1 = ""
 ...
 '           op1 = "*"
    ...
    If I = adDate Then
        Master.Requery
        Master.Filter = UCase(Master.Fields((List1.ListIndex + 1)).Name) & op & "'" & UCase(Text1.TEXT) & op1 & "'"
    ElseIf I = adChar Or I = adVarChar Or I = adLongVarChar Or I = adLongVarWChar Or I = adVarWChar Or I = adWChar Or I = adDBDate Then
        Master.Requery
    ...
    End If
aa:
'    If master.AbsolutePosition <= 0 Then
'    master.Caption = "                              (" & IIf(master.RecordCount  > 0, master.RecordCount, 0) & " Record(s) Found)"
'    Else
'    master.Caption = "Record No. " & master.AbsolutePosition & "                 (" & IIf(master.RecordCount  > 0, master.RecordCount, 0) & " Record(s) Found)"
'    End If

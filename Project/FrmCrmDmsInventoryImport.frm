...
Begin VB.Form FrmCrmDmsInventoryImport 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(1).Control(0)=   "Txt(24)"
         Tab(1).Control(1)=   "Txt(7)"
         Tab(1).Control(2)=   "Txt(8)"
         Tab(1).Control(3)=   "Txt(9)"
         Tab(1).Control(4)=   "Txt(10)"
         Tab(1).Control(5)=   "Txt(11)"
         Tab(1).Control(6)=   "Txt(12)"
         Tab(1).Control(7)=   "Txt(13)"
         Tab(1).Control(8)=   "Txt(25)"
         Tab(1).Control(9)=   "Txt(34)"
         Tab(1).Control(10)=   "Txt(35)"
         Tab(1).Control(11)=   "Txt(37)"
         Tab(1).Control(12)=   "Txt(38)"
         Tab(1).Control(13)=   "Lbl(22)"
         Tab(1).Control(14)=   "Lbl(5)"
         Tab(1).Control(15)=   "Lbl(6)"
         Tab(1).Control(16)=   "Lbl(7)"
         Tab(1).Control(17)=   "Lbl(8)"
         Tab(1).Control(18)=   "Lbl(9)"
         Tab(1).Control(19)=   "Lbl(10)"
         Tab(1).Control(20)=   "Lbl(11)"
         Tab(1).Control(21)=   "Lbl(23)"
         Tab(1).Control(22)=   "Lbl(32)"
         Tab(1).Control(23)=   "Lbl(33)"
         Tab(1).Control(24)=   "Lbl(35)"
         Tab(1).Control(25)=   "Lbl(36)"
         Tab(1).ControlCount=   26
         TabCaption(2)   =   "Account Parameters 2"
         TabPicture(2)   =   "FrmCrmDmsInventoryImport.frx":0038
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "Txt(14)"
         Tab(2).Control(1)=   "Txt(15)"
         Tab(2).Control(2)=   "Txt(16)"
         Tab(2).Control(3)=   "Txt(20)"
         Tab(2).Control(4)=   "Txt(21)"
         Tab(2).Control(5)=   "Txt(22)"
         Tab(2).Control(6)=   "Txt(23)"
         Tab(2).Control(7)=   "Txt(17)"
         Tab(2).Control(8)=   "Txt(18)"
         Tab(2).Control(9)=   "Txt(19)"
         Tab(2).Control(10)=   "Txt(26)"
         Tab(2).Control(11)=   "Txt(33)"
         Tab(2).Control(12)=   "Txt(36)"
         Tab(2).Control(13)=   "Lbl(12)"
         Tab(2).Control(14)=   "Lbl(13)"
         Tab(2).Control(15)=   "Lbl(14)"
         Tab(2).Control(16)=   "Lbl(18)"
         Tab(2).Control(17)=   "Lbl(19)"
         Tab(2).Control(18)=   "Lbl(20)"
         Tab(2).Control(19)=   "Lbl(21)"
         Tab(2).Control(20)=   "Lbl(15)"
         Tab(2).Control(21)=   "Lbl(16)"
         Tab(2).Control(22)=   "Lbl(17)"
         Tab(2).Control(23)=   "Lbl(24)"
         Tab(2).Control(24)=   "Lbl(31)"
         Tab(2).Control(25)=   "Lbl(34)"
         Tab(2).ControlCount=   26
         TabCaption(3)   =   "Other Detail"
         TabPicture(3)   =   "FrmCrmDmsInventoryImport.frx":0054
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "txtgrid2(0)"
         Tab(3).Control(1)=   "txtgrid1(0)"
         Tab(3).Control(2)=   "FGrid1"
         Tab(3).Control(3)=   "FGrid2"
         ...
         Tab(4).Control(0)=   "Txt(53)"
         Tab(4).Control(1)=   "Txt(52)"
         Tab(4).Control(2)=   "Txt(48)"
         Tab(4).Control(3)=   "Txt(47)"
         Tab(4).Control(4)=   "Txt(46)"
         Tab(4).Control(5)=   "Txt(45)"
         Tab(4).Control(6)=   "Lbl(51)"
         Tab(4).Control(7)=   "Lbl(50)"
         Tab(4).Control(8)=   "Lbl(46)"
         Tab(4).Control(9)=   "Lbl(45)"
         Tab(4).Control(10)=   "Lbl(44)"
         Tab(4).Control(11)=   "Lbl(43)"
         Tab(4).ControlCount=   12
         TabCaption(5)   =   "Vehicle Inventory Parameters"
         TabPicture(5)   =   "FrmCrmDmsInventoryImport.frx":008C
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "Txt(44)"
         Tab(5).Control(1)=   "Txt(43)"
         Tab(5).Control(2)=   "Txt(42)"
         Tab(5).Control(3)=   "Txt(41)"
         Tab(5).Control(4)=   "Txt(40)"
         Tab(5).Control(5)=   "Txt(39)"
         Tab(5).Control(6)=   "Lbl(42)"
         Tab(5).Control(7)=   "Lbl(41)"
         Tab(5).Control(8)=   "Lbl(40)"
         Tab(5).Control(9)=   "Lbl(39)"
         Tab(5).Control(10)=   "Lbl(38)"
         Tab(5).Control(11)=   "Lbl(37)"
         Tab(5).ControlCount=   12
         TabCaption(6)   =   "Job Bill IParameter"
         TabPicture(6)   =   "FrmCrmDmsInventoryImport.frx":00A8
         Tab(6).ControlEnabled=   0   'False
         Tab(6).Control(0)=   "Txt(51)"
         Tab(6).Control(1)=   "Txt(50)"
         Tab(6).Control(2)=   "Txt(49)"
         Tab(6).Control(3)=   "Lbl(49)"
         Tab(6).Control(4)=   "Lbl(48)"
         Tab(6).Control(5)=   "Lbl(47)"

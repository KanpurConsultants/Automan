...
'    If IsNotBlank(List1, FGrid.TextMatrix(List2, 0)) = False Then RepPrint = False: Exit Sub
    ...
    Select Case FGrid.TextMatrix(List2, 1)
        ...
        Case "SalesManWise"
            ...
            mQry = "SELECT VO.Inv_DocId, VO.Inv_Date, VO.OrdDocId,VO.Ord_Date,VO.Chassis as ChassisNo, VO.VRATE, " & _
                   ...
                   "S.Site_Desc, G.God_Name As Godown_Name, MC.ModelCat_Name As ModelCategoryName, VStk.BodyBuilder_IssDate, BB.BodyBuilderDesc, Bt.BodyTypeDesc, VO.Rebate, Produce.Produce_Name, ContractFinance.Add1 as FinAdd1, ContractFinance.Add2 as FinAdd2  " & _
                   ...
                   "Left Join Model_Cat MC On MC.ModelCat_Code = Model.Cat_Code " & _
                   "Left Join Produce On MC.Produce_Code = Produce.Produce_Code "
            GoTo NXT
    ...
    mQry = "SELECT VO.Inv_DocId, VO.Inv_Date, VO.OrdDocId,VO.Ord_Date,SG.NamePrefix, SG.Name, SG.FPrefix, " & _
        ...
        "MG.ModelGrp_Name, S.Site_Desc, G.God_Name As Godown_Name, MC.ModelCat_Name As ModelCategoryName, Model.Sales_Desc, Model.Model_Desc, 1 As Qty, VStk.BodyBuilder_IssDate, BB.BodyBuilderDesc, Bt.BodyTypeDesc, VO.Rebate, TF.L_C, Produce.Produce_Name, ContractFinance.Add1 as FinAdd1, ContractFinance.Add2 as FinAdd2 " & _
        "FROM ((((((((((((Veh_Order as VO LEFT JOIN Veh_Stock as VStk ON VO.chassis = VStk.ChassisNo) " & _
        "Left Join BodyBuilder BB On BB.BodyBuilderCode =  Vstk.BodyBuilder) " & _
        "Left Join BodyType Bt On Bt.BodyTypeCode =  Vstk.BodyBuilder_BodyType) " & _
        "LEFT JOIN Model ON VO.MODEL = Model.MODEL) " & _
...
'    If Check1(9).Value = Unchecked Then Condstr = Condstr & " and VO.Rep_Code in (" & GridString9 & ")"
    ...
    mQry = "SELECT " & mMainGrpStr & " as Vehicle_Type,M.Model_Desc,M.Sales_Desc, Produce.Produce_Name, " & mGrpStr & " As  Model, " & vIsNull("VP.Amount+VP.Addition-VP.Deduction+VP.Misc_Amt", "VS.Rate") & " AS VRATE, 0 as VRATE1, 0 as VRATE2, 1 as Opening, 0 as Purchase, 0 as LastPurch, 0 as Sale, 0 as LastSale, MG.ModelGrp_Name, 0 as Cancelled,0 as ClStk,0 as ClStkVal " & _
        ...
        " Left Join Produce on MC.Produce_Code=Produce.Produce_Code) " & _
    ...
    mQRY1 = "SELECT " & mMainGrpStr & " as Vehicle_Type,M.Model_Desc,M.Sales_Desc, Produce.Produce_Name, " & mGrpStr & " As  Model,0 as VRATE, " & vIsNull("VP.Amount+VP.Addition-VP.Deduction+VP.Misc_Amt", "VS.Rate") & " as VRATE1,0 as VRATE2,0 as Opening,1 as Purchase," & _
...
'        "  And VO.Inv_Date <= " & ConvertDate(Format(FGrid.TextMatrix(Date2, 1), "dd/MMM/yyyy")) & ")"
    ...
    mQRY2 = "SELECT " & mMainGrpStr & " as Vehicle_Type,M.Model_Desc,M.Sales_Desc, Produce.Produce_Name, " & mGrpStr & " As  Model,0 as VRATE,0 as VRATE1, " & IIf(StrCmp(left(PubComp_Name, 4), "Enar"), vIsNull("VP.Amount+VP.Addition-VP.Deduction+VP.Misc_Amt", "VS.Rate"), "Vo.Net_Amount - Vo.Tax_Amt") & " as VRATE2,0 as Opening,0 as Purchase,0 as LastPurch,1 as Sale, " & _
        " " & cIIF("VO.Inv_Date = " & ConvertDate(Format(FGrid.TextMatrix(Date2, 1), "dd/MMM/yyyy")) & "", "1", "0") & " as LastSale,MG.ModelGrp_Name, 0 as Cancelled,0 as ClStk,0 as ClStkVal " & _
        " from (((((((Veh_Stock as VS LEFT JOIN Model as M ON VS.MODEL = M.MODEL) " & _
        " Left Join Model_Grp MG on MG.ModelGrp_Code=M.Grp_Code) " & _
        " Left Join Model_Cat MC on MG.ModelCat_Code=MC.ModelCat_Code) " & _
    ...
    mQRY3 = "SELECT " & mMainGrpStr & " as Vehicle_Type,M.Model_Desc,M.Sales_Desc, Produce.Produce_Name, " & mGrpStr & " As  Model,0 as VRATE,0 as VRATE1,VO.Net_Amount-Vo.Tax_Amt as VRATE2,0 as Opening,0 as Purchase,0 as LastPurch,0 as Sale, " & _
    ...
    mQry4 = "SELECT " & mMainGrpStr & " as Vehicle_Type,M.Model_Desc,M.Sales_Desc, Produce.Produce_Name, " & mGrpStr & " As  Model,0 as VRATE,0 as VRATE1,0 as VRATE2,0 as Opening,0 as Purchase,0 as LastPurch,0 as Sale, " & _
    ...
    mQry4 = mQry4 & Condstr
        ...
        With RstRep
            .Fields.Append "Vehicle_Type", adChar, 50, adFldIsNullable
            ...
            .Fields.Append "Model_Desc", adChar, 100, adFldIsNullable
            .Fields.Append "Sales_Desc", adChar, 100, adFldIsNullable
            ...
            .Fields.Append "Produce_Name", adChar, 100, adFldIsNullable
...
'                    End If
                    ...
                    .Fields("Produce_Name") = XNull(Rst!Produce_Name)

...
'        Set Rst = GCn.Execute("SELECT Veh_Order.Inv_DocId,Veh_Purch2.Trn_Type,Veh_Purch2.QTY, Veh_AMDModel.Prod_Name " & _
        ...
        Print #1, mChr17 & RstDel!DelCh_UName & " " & RstDel!DelCh_UEntDt & Space(((PageWidth * 1.7) - Len("* a dataman software *") - Len(RstDel!DelCh_UName & " " & RstDel!DelCh_UEntDt)) / 2) & "* a dataman software *" & mChr18
    Print #1, mEject
    Close #1

...
'Print Area 18
    ...
    End If
        ...
        Print #1, mChr17 & RstQuot!U_Name & " " & STR(RstQuot!U_EntDt) & Space(((PageWidth * 1.7) - Len("* a dataman software *") - Len(RstQuot!U_Name & " " & STR(RstQuot!U_EntDt))) / 2) & "* a dataman software *" & mChr18
    Print #1, mEject
    Close #1

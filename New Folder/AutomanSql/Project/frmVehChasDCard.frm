...
'
'        Print #1, mChr17 + RstDel!DelCh_UName + " " + str(RstDel!DelCh_UEntDt) + Space(((PageWidth * 1.7) - Len("* a dataman software *") - Len(RstDel!DelCh_UName + " " + str(RstDel!DelCh_UEntDt))) / 2) + "* a dataman software *" + mChr18
'    Print #1, mEject
'    Close #1

...
Begin VB.Form ReprotSpare2 
   ...
   Begin VB.CommandButton BtnSpeed 
      BackColor       =   &H00C0FFFF&
      Caption         =   "Speed Print"
      DownPicture     =   "ReprotSpare2.frx":0000
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.CommandButton BTNEXIT 
      BackColor       =   &H00C0FFFF&
      Caption         =   "E&xit"
      DownPicture     =   "ReprotSpare2.frx":3132
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.CommandButton BTNPRINT 
      ...
      DownPicture     =   "ReprotSpare2.frx":6264
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ReprotSpare2"
...
Private Const SprSaleCtrlRep As Byte = 1
...
If SpeedPrn = True Then
    Call Report_View(rpt, RepTitle, 1, False)
Else
...
Select Case GRepFormName
    Case SprSaleCtrlRep
        With FGrid
            .TextMatrix(Date1, 0) = "Date From": .RowHeight(Date1) = GridRowHeight
...
'            .TextMatrix(List1, 1) = "QtyWise"
        ...
        GridSel(1).ColWidth(1) = 1200: GridSel(1).ColWidth(3) = 2800
End Select
End Sub
...
'        CondStr = " where left(P.OrderId,1)='" & PubDivCode & "' And  P.v_Date <= #" & Format(FGrid.TextMatrix(Date2, 1), "dd/MMM/yyyy") & "# and P.OrdClosDate Is Null "
'        If Check1(1).Value = Unchecked Then CondStr = CondStr & " and Mid(P.OrderId,3,1) in (" & GridString1 & ")"
'        If Check1(2).Value = Unchecked Then CondStr = CondStr & " and P.Party_Code in (" & GridString2 & ")"
'        If Check1(3).Value = Unchecked Then CondStr = CondStr & " and Left(P.OrderId,1) in (" & GridString3 & ")"
...
'        CondStr = " where left(S.OrderId,1)='" & PubDivCode & "' And  S.v_Date <= #" & Format(FGrid.TextMatrix(Date2, 1), "dd/MMM/yyyy") & "# and S.OrdClosDate Is Null "
'        'If Check1(1).Value = Unchecked Then CondStr = CondStr & " and left(S.site_code,1) in (" & GridString1 & ")"

...
If TypeOf Me.ActiveControl Is TextBox Or TypeOf Me.ActiveControl Is CheckBox Then
    If Frame1.Visible = False And TxtSearch.Visible = False Then If KeyCode = 13 Then SendKeys vbTab
End If
Select Case KeyCode
    Case 114
        LblShort_Click 0
